        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    id_typDania = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    id_stolik = table.Column<int>(type: "int", nullable: true),
                    id_kartaDan = table.Column<int>(type: "int", nullable: true),
                    id_kelner = table.Column<int>(type: "int", nullable: true),
                    data_zam = table.Column<DateTime>(type: "Date", nullable: false)
                },
                constraints: table =>
                {
